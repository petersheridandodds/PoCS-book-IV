...
%  \ding{228} All dose sizes are equal: $d=1$
  ...
  \textbf{Calculations---Fixed points for \tc{blue}{$r \le 1$}, $\dstar=1$, and \tc{blue}{$T \ge 1$}}
  ...
  \textbf{Calculations---Fixed points for $\dstar=1$, \tc{blue}{$r \le 1$}, and \tc{blue}{$T \ge 1$}}
...
%  $\dstar=3$, $T=12$ 
  ...
  \textbf{Calculations---Fixed points for $r = 1$, \tc{blue}{$\dstar > 1$}, and \tc{blue}{$T \ge 1$}}
...
e   SIS, some specific cases
  ...
  \textbf{Calculations---Fixed points for \tc{blue}{$r  1$}, and \tc{blue}{$T \ge 1$}}
...
% 
  \textbf{Calculations---Fixed points for \tc{blue}{$r < 1$}, \tc{blue}{$\dstar = 2$}, and \tc{blue}{$T = 3$}}
  $$
  \mbox{F.P.\ Eq:} \ \
  \phifix = \Gamma(p,\phifix;r) 
  + \sum_{i=\dstar}^{T}
