\begin{frame}[plain]
  ...
  \begin{block}{}
    \displaypaper{willett2014a}{1}
  \end{block}

  \begin{columns}
    \column{0.025\textwidth}  
    \column{0.50\textwidth}  
    \includegraphics[width=\textwidth,height=0.65\textheight,keepaspectratio]{willett2014a_fig1}
    \column{0.025\textwidth}  
...
\begin{frame}
  ...
  \youtubevideo{FnroL1_-l2c}{}{}

  \bigskip

  More: \wordwikilink{http://www.sciencedaily.com/releases/2014/03/140306142759.htm}{How
    river networks move across a landscape} (Science Daily)
...
\begin{frame}[label=]
  ...
  \begin{block}{Not quite:}
    ...
    \item<3-> 
      \insertassignmentquestionsoft{2}{2}
    \end{itemize}
  \end{block}
...
\neuralreboot{5mUs70SqD4o}{}{}{Fwoompff}
...
\neuralreboot{D0LMc8tGMNk}{}{}{Feline elevation}
